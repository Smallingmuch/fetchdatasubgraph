...
export class PauserAdded extends Entity {
  ...
  static loadInBlock(id: Bytes): PauserAdded | null {
    return changetype<PauserAdded | null>(
      store.get_in_block("PauserAdded", id.toHexString())
    );
  }
...
export class PauserRemoved extends Entity {
  ...
  static loadInBlock(id: Bytes): PauserRemoved | null {
    return changetype<PauserRemoved | null>(
      store.get_in_block("PauserRemoved", id.toHexString())
    );
  }
